USE mydb;
INSERT INTO users (username, password, phone, email, role, fullName, birthdate, avatar_path)
...
INSERT INTO products (product_id, product_name, price, description, user_id, category_id, quantityInStock)
